...
import charm.itemset_array_integers_with_tids_bitset.Itemset;
import charm.itemset_array_integers_with_tids_bitset.Itemsets;
import charm.ArraysAlgos;
import charm.TriangularMatrix;
...
//				+ MemoryLogger.getInstance().getMaxMemory() + " mb");
	...
	private void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		charm.itemset_array_integers_with_count.Itemset itemset = new charm.itemset_array_integers_with_count.Itemset(prefixSuffix);
...
//				writer.write(itemset.toString() + " #SUP: " + itemset.support);
				...
				{
					writer.write(itemset.toString().hashCode() + ";" + itemset.support + ";" + itemset.toString());
					writer.newLine();
				}
			}
