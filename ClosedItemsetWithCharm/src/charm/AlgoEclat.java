...
import charm.itemset_array_integers_with_tids.Itemset;
import charm.itemset_array_integers_with_tids.Itemsets;
...
loopJ:		for(int j=i+1; j < frequentItems.size(); j++) {
				...
				if(useTriangularMatrixOptimization || tidsetIJ.size() >= minsupRelative){
